...
Route::controller(AccountController::class)->group(function () {
    ...
    })->name('change')->middleware('permission:view_profile');
    //logout
    Route::get('logout', 'logout')->name('logout');
    //change_password
    Route::post('profile/change_pas', 'change_pas')->name('change_pas_save');
    //change_profile
    Route::post('profile/change_info', 'change_info')->name('change_info_save')->middleware('permission:change_profile');
    //change_tel_number
    ...
    Route::get('registratura/register_new', 'manage_register_new')->name('manage_new_register')->middleware('permission:manage');
    Route::post('registratura/save_new_user','save_manage_user')->name('manage_save_new_user')->middleware('permission:manage');
 ...
 Route::fallback(fn()=>redirect()->route('main'));
