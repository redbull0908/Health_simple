...
<div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
    <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
        <div class="d-flex justify-center align-items-center pt-8 sm:justify-start sm:pt-0">
            ...
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <a class="ml-4 mt-0 btn btn-primary" href="<?php echo e(route('main')); ?>">На главную</a>
            </div>
        </div>
    </div>
...
<?php /**PATH E:\PHP\OSPanel\domains\Health-Test\resources\views/errors/403.blade.php ENDPATH**/ ?>