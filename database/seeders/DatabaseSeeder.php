...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('schedule_templates')->insert([
            'name' => 'Первая половина дня',
            'time_from' => '8:00',
            'time_to' => '14:00',
            'interval' => 15
        ]);
        \DB::table('schedule_templates')->insert([
            'name' => 'Вторая половина дня',
            'time_from' => '14:00',
            'time_to' => '20:00',
            'interval' => 15
        ]);
        ...
        $view_profile = Permission::create(['name' => 'view_profile']);
        ...
        $admin_panel = Permission::create(['name' => 'admin_panel']);
        ...
        User::create([
            'login' => 'super_user',
            'full_name' => 'admin',
            'password' => \Hash::make('C686h9lopykm'),
        ])->assignRole('super-user')->givePermissionTo('admin_panel');
