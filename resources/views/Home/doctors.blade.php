@extends('layouts.index' ,['title'=>'Врачи'])
@section('content')
<!-- Start Hero -->
        ...
        <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-8 gap-[30px]">
            @foreach($doctors as $doctor)
                ...
                <div class="team p-6 rounded-md shadow-md dark:shadow-gray-800 dark:border-gray-700 bg-white dark:bg-slate-900 relative">
                    ...
                    <img src="{{asset('storage/'.$doctor->img)}}" class="h-[320px] m-auto rounded-3xl shadow-md dark:shadow-gray-800" alt="">

                    <div class="content mt-4 text-center">
                        <a href="" class="mb-1 text-lg font-medium hover:text-indigo-600 block">{{$doctor->full_name}}</a>
